              ...
              <div className="p-4 sm:p-6 pb-8 sm:pb-6 safe-bottom">
                ...
                <form onSubmit={handleFormSubmit} className="space-y-4">
                  ...
                  <div className="border-t pt-4">
                    ...
                    <div className="space-y-3" data-cy="guests-documents-section">
                      {guestDocuments.length > 0 ? (
                        <div className="space-y-2" data-cy="guests-documents-list">
                          {guestDocuments.map(doc => (
                            <div key={doc._id} className="flex items-center justify-between bg-muted/30 rounded p-3 border gap-2" data-cy="guests-document-item">
                              ...
                              <div className="flex items-center gap-2 shrink-0">
                                <button type="button" onClick={() => setPreviewDocument(doc)} className="px-2 py-1 text-xs text-primary hover:underline touch-target-sm" data-cy="guests-document-view">View</button>
                                {(user?.role === 'super_admin' || user?.role === 'manager') && (
                                  <button type="button" onClick={() => handleDeleteDocument(doc._id)} className="px-2 py-1 text-xs text-red-600 hover:underline touch-target-sm" data-cy="guests-document-delete">Delete</button>
                                )}
                              </div>
                            </div>
                          ))}
                        ...
                        <p className="text-sm text-muted-foreground" data-cy="guests-documents-empty">No documents uploaded yet.</p>
                      )}
                      <div className="flex flex-col sm:flex-row gap-3 items-start sm:items-end">
                        <div className="flex-1 w-full">
                          ...
                          <input
                            ...
                            data-cy="guests-document-file-input"
                          />
                        </div>
                        ...
                        <button
                          ...
                          data-cy="guests-document-upload"
                        >
